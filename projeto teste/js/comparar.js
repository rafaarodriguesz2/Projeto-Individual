function converter() {
    ...
    <img src="../img/banco_de_carros/brasil/${numeroAleatorio}.jpg" alt="lambo" class="img-carros">
    ...
    <img src="../img/banco_de_carros/eua/${numeroAleatorio}.jpg" alt="lambo" class="img-carros">
